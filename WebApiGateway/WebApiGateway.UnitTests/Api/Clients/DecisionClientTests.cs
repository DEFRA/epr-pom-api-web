...
public class DecisionClientTests
{
    ...
    {
        // Arrange
        var decision = new List<PomDecision>();
        var expectedId = Guid.NewGuid();
        decision.Add(new PomDecision { Id = expectedId, Decision = "Accepted", Created = DateTime.Now.AddHours(-2) });
        decision.Add(new PomDecision { Id = Guid.NewGuid(), Decision = "Rejected", Created = DateTime.Now.AddDays(-2) });
