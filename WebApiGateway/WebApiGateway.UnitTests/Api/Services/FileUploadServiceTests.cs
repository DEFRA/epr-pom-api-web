...
public class FileUploadServiceTests
{
    ...
    public async Task UploadFileAsync_CreatesNewSubmissionAndAntivirusCheckEvent_WhenUploadingPomFileWithNoPreviousSubmissionId()
    {
        ...
        // Act
        var result = await _systemUnderTest.UploadFileAsync(fileStream, SubmissionType.Producer, null, Filename, SubmissionPeriod, null, null, null, null, "journey");
    ...
    public async Task UploadFileAsync_CreatesNewSubmissionAndAntivirusCheckEvent_WhenUploadingCompanyDetailsFileWithNoPreviousSubmissionId()
    {
        ...
        // Act
        var result = await _systemUnderTest.UploadFileAsync(fileStream, SubmissionType.Registration, SubmissionSubType.CompanyDetails, Filename, SubmissionPeriod, null, null, null, true, "journey");
    ...
    public async Task UploadFileAsync_CreatesOnlyAntivirusCheckEvent_WhenReUploadingPomFileWithPreviousSubmissionId()
    {
        ...
        // Act
        var result = await _systemUnderTest.UploadFileAsync(fileStream, SubmissionType, null, Filename, SubmissionPeriod, originalSubmissionId, null, null, false, "journey");
    ...
    public async Task UploadFileAsync_CreatesOnlyAntivirusCheckEvent_WhenReUploadingCompanyDetailsFileWithPreviousSubmissionId()
    {
        ...
        // Act
        var result = await _systemUnderTest.UploadFileAsync(fileStream, SubmissionType, SubmissionSubType, Filename, SubmissionPeriod, originalSubmissionId, registrationSetId, null, null, "journey");
    ...
    public async Task UploadFileSubsidiaryAsync_CallsSendFile_WhenUploadingSubsidiaryFile()
    {
        ...
        // Act
        await _systemUnderTest.UploadFileSubsidiaryAsync(fileStream, SubmissionType.Subsidiary, Filename, null, "journey");
    ...
    public async Task UploadAccreditationAsync_CreatesSubmission_WhenUploadingAccreditationFile()
    {
        ...
        // Act
        var result = await _systemUnderTest.UploadFileAccreditationAsync(fileStream, submissionType, Filename, originalSubmissionId, "journey");
